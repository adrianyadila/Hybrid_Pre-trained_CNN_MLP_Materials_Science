...
ap.add_argument("-b", "--baseCNN_A", required=True, help="path to baseCNN_A")
...
base_CNN_A = load_model(args["baseCNN_A"])
#print(base_CNN_A.summary())
#print(base_multioutput.get_config())

# Get the weights from the CNN A
weights_CNN_A = base_CNN_A.get_weights()

#print('weights da base CNN A')
#print(weights_CNN_A)
...
# Check Weights of the hybrid model...
HYBRID_CNN_wts = cnn.get_weights()
#print('weights da multilabel')
#print(HYBRID_CNN_wts)

#Get the configuration for the updated model and extract layer names. 
cnn_config = cnn.get_config()
#print(cnn_config)

multilabel_layer_names=[layer.name for layer in cnn.layers]
#print(multilabel_layer_names)

#Changing the weights of the multilabel for each layer that has weights

#=======Layer 1=======
target_layer1 = cnn.get_layer('conv2d')
layer1 = base_CNN_A.get_layer('conv2d')

weights_layer1 = layer1.get_weights()[0]
bias_layer1 = layer1.get_weights()[1]

target_layer1.set_weights([weights_layer1, bias_layer1])
target_layer1.trainable = False

#=======Layer 2=======
target_layer2 = model.get_layer('conv2d_1')
layer2 = base_CNN_A.get_layer('conv2d_1')

weights_layer2 = layer2.get_weights()[0]
bias_layer2 = layer2.get_weights()[1]

target_layer2.set_weights([weights_layer2, bias_layer2])
target_layer2.trainable = False

#=======Layer 3=======
#target_layer3 = model.get_layer('conv2d_2')
#layer3 = base_CNN_A.get_layer('M2_layer_5')

#weights_layer3 = layer3.get_weights()[0]
#bias_layer3 = layer3.get_weights()[1]

#target_layer3.set_weights([weights_layer3, bias_layer3])
#target_layer3.trainable = False

#=======Layer 4=======
#target_layer4 = model.get_layer('conv2d_3')
#layer4 = base_CNN_A.get_layer('M2_layer_7')

#weights_layer4 = layer4.get_weights()[0]
#bias_layer4 = layer4.get_weights()[1]

#target_layer4.set_weights([weights_layer4, bias_layer4])
#target_layer4.trainable = False
...
plot_model(model, to_file='pre-trained_model.png', show_shapes=True, show_layer_names=True)
