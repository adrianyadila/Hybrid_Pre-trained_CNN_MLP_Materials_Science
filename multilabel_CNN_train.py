...
# distribution
model_new.compile(loss="binary_crossentropy", optimizer=opt,
	metrics=["accuracy"])
...
H = model_new.fit(x=aug.flow(trainX, trainY, batch_size=BS), 
